...
![OpenAI军事化路径：2024.01删禁令→06 NSA局长入董→1](images/img_0_openai_military_timeline.png)
...
**《Anthropic蒸馏门》**那篇调查里，我跟踪的是Anthropic内部安全架构的松动——RSP改版削弱了安全委员会的否决权。那篇的指向是：内部安全机制在弱化。

现在同一家公司对外硬刚了五角大楼。两件事矛盾吗？不一定——内部流程松动和对外划红线可以同时发生。但有一个问题绕不开：当内部安全审查已经松了一圈，对外画的那条红线，靠什么执行？
...
![CBS新闻采访Dario Amodei截图或Anthropic官方声明](images/img_1_cbs_dario_interview_thumb.png)
...
![标题"Our agreement with the Departmen](images/img_2_openai_dow_blog.png)
...
值得注意的是，OpenAI最终谈成的协议，据报道包含了与Anthropic完全相同的两条红线。NPR、CNBC等多家媒体指出：目前没有公开解释，两份协议之间的实质差异到底在哪里。

三天后（3月1日），Altman在X上回应公众质疑时说："It was definitely rushed, and the optics don't look good."（这事儿确实仓促了，看起来不太好看。）
...
为什么没有立刻替换？原因是技术锁定：据报道，Claude已经太深入地整合进五角大楼的机密系统，短时间内物理上无法切换。Defense One引述的说法是：替换需要数月。
...
这件事的主要破题报道来自《华尔街日报》，Engadget、Yahoo News等随后援引跟进，均称CENTCOM使用Claude进行情报评估、目标识别与作战推演。另有Algemeiner、Blockonomi、WION、Republic World的报道，但各家在技术细节上存在出入。CENTCOM拒绝就具体使用系统置评（declined to comment）。Anthropic没有公开回应这部分报道。

已知：Claude在这次行动中被使用。

未知：被用到了哪个层面，与打击决策的实际关联有多深。

![OpenAI路径（主动合作）vs Anthropic路径（划线→被封→](images/img_3_openai_vs_anthropic_paths.png)
...
| 2026-03-01 | — | 哈梅内伊确认死亡 |
| 2026-03-04 | — | Amodei内部备忘录泄露：称OpenAI"straight up lies" |
| 2026-03-05 | — | Amodei与五角大楼重新谈判 / 发官方声明 / 宣布法律挑战 |
| 2026-03-06 | — | Amodei就备忘录语气道歉，实质指控未收回 |
...
上面的文字写于3月2日。之后又发生了几件事。

3月4日，Amodei在2月27日发给约2000名员工的内部备忘录被泄露。备忘录大约1600字。里面他称OpenAI的公开说辞是"straight up lies"（赤裸裸的谎言），称他们的安全承诺是"safety theatre"（安全表演），称OpenAI员工"gullible"（轻信），称网上支持者"Twitter morons"。

他还给出了一个判断：Anthropic遭到封杀，部分原因是"拒绝对总统进行dictator-style praise（独裁者式的赞美）"。作为对比，他提到Altman向特朗普就职典礼捐了100万美元，OpenAI总裁Brockman夫妇向特朗普超级政治行动委员会MAGA Inc捐了2500万美元。

这份备忘录把路线分歧变成了人身攻击。

3月5日，两件事同时发生。

一件是安静的：Amodei联系了Emil Michael——国防部研究与工程副部长——重新开始谈判。据FT报道，双方此前的谈判曾非常接近达成协议。五角大楼提出可以接受Anthropic的条款，只要求删除一个短语："analysis of bulk acquired data"（对批量获取数据的分析）。Amodei说，这恰恰是他们最担心的场景——大规模数据采集分析，距离大规模监控只隔一层窗户纸。

另一件是公开的：Anthropic发布官方声明，确认收到supply chain risk标签，但澄清范围比Hegseth宣布的窄——仅限五角大楼直接合同，不阻断军方承包商与Anthropic的所有商业关系。Anthropic宣布将在法庭挑战这个标签，理由是五角大楼可能超越了相关法规（10 USC 3252）的授权范围。

3月6日，Amodei就泄露备忘录的语气道歉。他说那份备忘录"written hastily"（仓促写成），不代表他"careful or considered views"（深思熟虑的观点）。

但他没有收回实质指控。

> 备忘录里骂人，官方声明里讲法律，谈判桌上谈短语。三条线同时在跑。

上一版结尾写的是"没有答案的问题"。现在答案开始浮出来了，但不是以任何人预期的方式——不是谁赢谁输，而是画了红线的人回到了谈判桌上，围绕一个短语讨价还价。

这个故事还在继续。

---

*降临派手记 · 大史执笔 · 2026-03-02 初版 / 2026-03-08 更新*
...
- Anthropic官博：《Anthropic and the Department of Defense to advance responsible AI in defense operations》（2025-07-14）
...
- Axios / CNN / CNBC：Altman表态"相同红线"（2026-02-27）
- NPR / CNBC：OpenAI协议与Anthropic红线相同、两份协议实质差异存疑（2026-02-27/28）
...
- TechCrunch：《OpenAI shares more details about its agreement with the Pentagon》（2026-03-01，含Altman "optics don't look good"）
...
- TechCrunch：《Anthropic CEO Dario Amodei calls OpenAI's messaging around military deal 'straight up lies'》（2026-03-04）
- WION：Amodei内部备忘录全文细节，含捐款数据和"dictator-style praise"原话（2026-03-04）
- Bloomberg / FT / CNBC：Anthropic与五角大楼重新谈判，Emil Michael（2026-03-05）
- TechCrunch：《Anthropic CEO could still be trying to make a deal with Pentagon》（2026-03-05）
- Anthropic官博：《Statement from Dario Amodei on our discussions with the Department of War》（2026-03-05）
- Fortune：Amodei就泄露备忘录道歉 + supply chain risk标签范围澄清（2026-03-06）
- Axios：《Scoop: Anthropic CEO apologizes for leaked memo criticizing Trump》（2026-03-06）