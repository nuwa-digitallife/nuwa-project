...
上一篇蒸馏门调查里，我们跟踪了Anthropic和它的竞争对手们。这一次换一个角度——**看钱和人往哪里走。**
...
同一天，Altman在公开场合"声援"Anthropic，批评五角大楼对科技公司"威胁性"的做法，说这对整个行业不利。
...
Algemeiner、Blockonomi、WION、Republic World都报道了Claude被使用这一基本事实——但各家的报道在技术细节上存在出入。CENTCOM没有公开说明Claude的具体使用范围。Anthropic没有公开回应这部分报道。
...
- Algemeiner / Blockonomi / WION / Republic World：Claude参与伊朗打击（2026-03-01）
